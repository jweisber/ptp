...
I think the correct explanation involves a famous precept known as *The Total Evidence Requirement*. It says pretty much what it sounds like: to get the true probability of something, you have to take account of *all* the evidence you have. And the guard wouldn't just be telling her that B will be released. She would also be telling her (implicitly) that the guard chose to identify B as one of the released prisoners.
